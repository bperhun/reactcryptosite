        ...
        <main>
            <div className="main-screen">
                <div className="container">
                    ...
                    <div className="main-screan__atom">
            ...
            <div className="main-telegram">
                <div className="container">
                    <div className="main-telegram__row">
                        <div className="main-telegram__left">
                            <img src="/img/img_iphone.png" alt="Картинка афона с открытым телеграмом" />
                        </div>
                        <div className="main-telegram__right">
                            <h2>Наш телеграм</h2>
            ...
            <div className="main-new-traders">
                <div className="container">
                    <div className="main-new-traders__row">
                        <div className="main-new-traders__left">
                            <div className="main-new-traders__card">
                                <div className="main-new-traders__circle"></div>
                                <div className="main-new-traders__circle"></div>
                                <h2>Для новичков</h2>
                        ...
                        <div className="main-new-traders__right">
            ...
            <div className="main-our-project">
                <div className="container">
                    <div className="main-our-project__row">
                        <div className="main-our-project__left">
                            <img src="/img/crypro_projects.png" alt="Картинка биткоина" />
                        </div>
                        <div className="main-our-project__right">
                            <div className="main-our-project__card">
                                <div className="main-our-project__circle"></div>
                                <div className="main-our-project__circle"></div>
                                <h2>наши проекты</h2>
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusamus sapiente, non quos eligendi
                                    impedit
